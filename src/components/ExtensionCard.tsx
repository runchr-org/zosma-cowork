...
export function ExtensionCard({
	...
	return (
		<div
			...
			className="w-full text-left px-3 py-2.5 rounded-lg border border-sidebar-border bg-sidebar-background/30 hover:bg-sidebar-accent/50 hover:border-sidebar-accent/30 transition-all cursor-pointer group focus:outline-none focus-visible:ring-2 focus-visible:ring-ring/40"
		>
				...
				<div className="shrink-0">
					{installed && removable ? (
						...
						<button
							...
							className="px-2 py-1 text-[10px] font-medium text-primary-foreground bg-primary rounded-md hover:brightness-110 disabled:opacity-50 transition-all"
						>
